                ...
                <div className="col-md-10 offset-md-1">
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            ...
                            <div className="invalid-feedback">사용할 수 없는 아이디</div>        
                        </div>
                    </div>
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            ...
                            <input type="password" name="memberPw" 
                                    ...
                                    `}
                                    value={member.memberPw} onChange={changeMember} onBlur={checkMember}/>
                            <div className="valid-feedback">올바른 비밀번호</div>        
                            <div className="invalid-feedback">형식이 틀렸습니다</div>
                        </div>
                    </div>
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            ...
                            <input type="password" name="memberPwRe" 
                                    ...
                                    `}
                                    value={member.memberPwRe} onChange={changeMember} onBlur={checkMember}/>
                            <div className="valid-feedback">일치합니다</div>        
                            <div className="invalid-feedback">불일치합니다</div>
                        </div>
                    </div>
